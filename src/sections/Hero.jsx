        ...
        <section className="hero-immersive">
            ...
            <div className="hero-content-wrapper">
                ...
                >
                    ...
                    <motion.div className="hero-btns" style={{ display: 'flex', gap: '25px', justifyContent: 'center', alignItems: 'center' }}>
                        {socialLinks.map((social, i) => {
                            // Map names to match your file names: "Instagram.svg", "Facebook.svg", "Tik Tok.svg"
                            const iconMap = {
                                'instagram': 'Instagram.svg',
                                'facebook': 'Facebook.svg',
                                'tiktok': 'Tik Tok.svg'
                            };
                            const iconFile = iconMap[social.name];
